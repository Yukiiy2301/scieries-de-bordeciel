...
export type Database = {
  _analytics: {
    Tables: {
      ...
      log_events_05608586_8a42_4978_9f27_c2e6bda48ee3: {
        Row: {
          body: Json | null
      ...
      log_events_1b045077_761d_476a_a4fb_a7797bdf6ed6: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_1b22d478_23c9_4430_b543_319cdd2acef7: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_55307a61_bafe_46f8_81fc_56875397b2d8: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_5cfb409d_123d_4c96_be20_3b8b6f8596e4: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_659fe0eb_c983_4e37_a6e3_81e43af9d069: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_847fc4f6_2eb9_4bff_8653_99e48fec6e33: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_88630e5b_2bc6_4523_b37b_869615d48982: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_e417a462_3ba5_4f4b_9a7d_e20cbd8c538d: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
    ...
    Tables: {
      ...
      debts: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "debts_sawmill_id_fkey"
            columns: ["sawmill_id"]
      ...
      member_stocks: {
        ...
        Relationships: [
          {
            foreignKeyName: "member_stocks_member_id_fkey"
            columns: ["member_id"]
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "member_stocks_product_id_fkey"
            columns: ["product_id"]
            referencedRelation: "products"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "member_stocks_sawmill_id_fkey"
            columns: ["sawmill_id"]
            referencedRelation: "sawmills"
            referencedColumns: ["id"]
          },
      ...
      orders: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "orders_sawmill_id_fkey"
            columns: ["sawmill_id"]
            referencedRelation: "sawmills"
            referencedColumns: ["id"]
          },
      ...
      sale_lines: {
        ...
        Relationships: [
          {
            foreignKeyName: "sale_lines_member_id_fkey"
            columns: ["member_id"]
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          },
      ...
      sales: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "sales_sawmill_id_fkey"
            columns: ["sawmill_id"]
            referencedRelation: "sawmills"
            referencedColumns: ["id"]
          },
      ...
      sawmills: {
        Row: {
          citizenship_charcoal: number
          citizenship_septims: number
          id: string
          name: string
          tax_rate: number
        }
      ...
      settlements: {
        ...
        Relationships: [
          {
            foreignKeyName: "settlements_member_id_fkey"
            columns: ["member_id"]
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "settlements_sawmill_id_fkey"
            columns: ["sawmill_id"]
            referencedRelation: "sawmills"
            referencedColumns: ["id"]
          },
      ...
      stock_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "stock_requests_member_id_fkey"
            columns: ["member_id"]
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          },
          ...
          {
            foreignKeyName: "stock_requests_sawmill_id_fkey"
            columns: ["sawmill_id"]
            referencedRelation: "sawmills"
            referencedColumns: ["id"]
          },
